...
export function InventoryDateFilter({ className }: InventoryDateFilterProps) {
  const { dateRange, setDateRange, clearFilter } = useInventoryDateFilter()
  const [selectedPreset, setSelectedPreset] = useState("alltime") // Default to "alltime" for inventory
